...
<button id="boton_mostrar_subir" class="boton">Subir publicacion</button>
<div class="subir" style="display:none;">
    <div class="publi-info-perfil">
        <label for="subir-sms-oculto" onclick="responsive_voice('Los datos a introducir son: titulo,autor,fecha,categoria,resumen,introduccion,contenido,conclusiones,referencias, subir archivo y demas detalles al final se envia todo con el icono publicar','Seccion para subir publicacion')"><strong>Ayuda para subir:📢</strong></label>
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" method="post">
        <center>
            <table width="90%" border="1">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <label for="introduccion" class="label_contenidos"><strong>Introduccion:</strong></label>
                        </td>
                        <td>
                            <div>
                                <textarea name=subir_cont[introduccion][0][0][parrafo]" id="introduccion" class="contenidos" rows="4" cols="40" placeholder="escribir la introduccion"></textarea><br>
        ...
        <center><input type="submit" value="Publicar" name="publicar" class="boton"></center>
    </form>
</div>
</div> 